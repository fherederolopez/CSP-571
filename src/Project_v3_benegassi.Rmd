...
setwd("C:/Users/alvar/OneDrive/Documentos/Universidad/Chicago/Data Preparation and Analysis/Project/Entrega Final")
...
model <- rpart(cardio ~ ., data=train, method="class")
rpart.plot(model, extra=104, type=4)
# Evaluation
heart_pred <- predict(model, test, type="class")
ConfMatrix <- confusionMatrix(heart_pred, as.factor(test$cardio))
ConfMatrix
